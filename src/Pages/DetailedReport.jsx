        ...
        <div className="bg-white rounded-xl p-4">
            ...
            <div className="flex justify-between items-center mb-4">
                <div className="flex items-center gap-3">
                    <img src="./File text 1.png" alt="Logo" className="w-6 h-6 object-contain" />
                ...
                <div className="flex gap-2">
                    ...
                    <button className="border border-pink-500 flex items-center gap-2 text-pink-600 text-sm px-4 py-2 rounded-lg hover:bg-pink-100">
                        <img src="./Download.png" alt="import" className="w-4 h-4" /> Import
                    </button>
                    <button className="border border-pink-500 flex items-center gap-2 text-pink-600 text-sm px-4 py-2 rounded-lg hover:bg-pink-100">
                        <img src="./Move up.png" alt="export" className="w-4 h-4" /> Export
                    </button>
                </div>
            </div>
